    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create and manage schools, configure term-wise tuition fees, bus fees, and more.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      {showAddForm && (
        <Card>
            <CardHeader>
            <CardTitle>{editingSchool ? `Edit School: ${editingSchool.schoolName}` : "Create New School"}</CardTitle>
            </CardHeader>
            <CardContent>
            <Form {...form}>
                ...
                <div className="flex gap-2 pt-6">
                    ...
                    <Button type="button" variant="outline" onClick={cancelAndCloseForm} disabled={isSubmitting}>
            ...
            <Card key={school._id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 gap-4">
              ...
              <div className="flex gap-2">
                ...
                <AlertDialog open={schoolToDelete?._id === school._id} onOpenChange={(open) => !open && setSchoolToDelete(null)}>
                    ...
                    {schoolToDelete && schoolToDelete._id === school._id && (
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                            <AlertDialogDescription>
                                This action cannot be undone. This will permanently delete the <strong>{school.schoolName}</strong> school profile.
                                <br/><br/>
                                <strong className="text-destructive">Note:</strong> Deletion will fail if there are any users (admins, teachers, students) still associated with this school.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
